...
function vw_landing_page_ie_stylesheet(){
	wp_enqueue_style('vw-landing-page-ie', get_template_directory_uri().'/css/ie.css');
	wp_style_add_data( 'vw-landing-page-ie', 'conditional', 'IE' );
}
add_action('wp_enqueue_scripts','vw_landing_page_ie_stylesheet');
...
define('VW_LANDING_PAGE_FREE_THEME_DOC','https://www.vwthemesdemo.com/docs/free-vw-landing-page/','vw-landing-page');
define('VW_LANDING_PAGE_SUPPORT','https://wordpress.org/support/theme/vw-landing-page/','vw-landing-page');
define('VW_LANDING_PAGE_REVIEW','https://wordpress.org/support/theme/vw-landing-page/reviews','vw-landing-page');
define('VW_LANDING_PAGE_BUY_NOW','https://www.vwthemes.com/themes/wordpress-landing-page-theme/','vw-landing-page');
define('VW_LANDING_PAGE_LIVE_DEMO','https://www.vwthemes.net/vw-landing-page-pro/','vw-landing-page');
define('VW_LANDING_PAGE_PRO_DOC','https://www.vwthemesdemo.com/docs/vw-landing-page-pro/','vw-landing-page');
define('VW_LANDING_PAGE_FAQ','https://www.vwthemes.com/faqs/','vw-landing-page');
define('VW_LANDING_PAGE_CONTACT','https://www.vwthemes.com/contact/','vw-landing-page');
define('VW_LANDING_PAGE_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-landing-page');

define('VW_LANDING_PAGE_CREDIT','https://www.vwthemes.com/themes/free-wordpress-landing-page-theme/','vw-landing-page');
